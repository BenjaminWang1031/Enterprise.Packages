...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['cssgradients'] = function() {
         ...
         * Enterpriseer.mozilla.org/en/CSS/-moz-linear-gradient
         * Enterpriseer.mozilla.org/en/CSS/-moz-radial-gradient
    ...
    tests['audio'] = function() {
        ...
        try { 
            if ( bool = !!elem.canPlayType ) {
                ...
                // Mimetypes accepted:
                //   Enterpriseer.mozilla.org/En/Media_formats_supported_by_the_audio_and_video_elements
